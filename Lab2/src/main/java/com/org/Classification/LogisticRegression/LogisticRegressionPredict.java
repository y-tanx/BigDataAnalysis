...
/**
 * LogsticRegressionPredict类：对数据集进行分类
 */
public class LogisticRegressionPredict {
    ...
    public static class LRReducer extends Reducer<LongWritable, Text, LongWritable, IntWritable> {
        ...
        protected void reduce(LongWritable key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
            ...
            // 输出预测错误的记录
            context.write(new LongWritable(lineNumber), new IntWritable(predictedClass));
            lineNumber++;
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        String outputPath = "hdfs://myc-ubuntu:9000/Lab2/classification/LR/test_Done";
        ...
        // 创建MapReduce作业
        Job job = Job.getInstance(conf, "LR Test");
        // 指定Mapper类和Reducer类
        job.setMapperClass(LogisticRegressionPredict.LRMapper.class);
        job.setReducerClass(LogisticRegressionPredict.LRReducer.class);
        // 指定maptask的输出类型
